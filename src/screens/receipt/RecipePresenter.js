...
class RecipePresenter extends Component{
  ...
  click = (num) =>{
    fetch('http://192.168.0.145:3344/recipe/RecipeList',{
        method: "post",
        headers :{
  ...
  getinfo = async (num) =>{
   res = await fetch('http://192.168.0.145:3344/recipe/getinfo',{
        method: "post",
        headers :{
            "content-Type" : "application/json",
        },
  ...
  getingre =  async (num) =>{
   res2 = await fetch('http://192.168.0.145:3344/recipe/getingre',{
        method: "post",
        headers :{
            "content-Type" : "application/json",
        },
  ...
  getdetailrecipe = async (num) =>{
   res3 = await fetch('http://192.168.0.145:3344/recipe/getdetailrecipe',{
        method: "post",
        headers :{
            "content-Type" : "application/json",
        },
