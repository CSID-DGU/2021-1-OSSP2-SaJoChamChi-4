          ...
          routes: [
            {
              ...
              params: {
                params: {
                  ...
                  summary: route.params.params.summary,
                  detailrecipe: route.params.params.detailrecipe,
                  info: route.params.params.info,
                  ingre: route.params.params.ingre,
                  data2: true,
                },
              },
            },
    ...
    >
      <Container>
        ...
        <Text style={{ fontSize: 20, fontWeight: "bold", textAlign: "center" }}>
          요약: {route.params.params.summary}
          {"\n"}{" "}
        </Text>
        {info}
        {ingre}
        ...
        {route.params.params.data2 == null ? (
          <Button
            title="좋아요"
            onPress={likePressed}
            containerStyle={{
